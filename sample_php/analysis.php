        ...
        <ul>
          ...
          <li>
            ...
            <div id="content" class="auto-style1" style="overflow: auto; height: 791px; left: 245px; max-height: none; position: absolute; top: 23px; border: thick #000000 double; color: #000000; font: icon; font-family: Calibri; font-size:xx-large;">
           	 &nbsp;&nbsp;<a href="top6.php" style="left: 8px; top: 1px; width: 686px; height: 41px; font-size: 7mm;" style="font-size:3mm">A STATISTICAL LOOK AT THE PREMIER LEAGUE TOP SIX<img src="css/images/main-1.png" height="48" width="48" align="left" style="margin-right:10px"></a>
			 &nbsp;&nbsp;<a href="kvm.php" style="left: 8px; top: 1px; width: 686px; height: 41px; font-size: 7mm;" style="font-size:3mm">KARIUS VS. MIGNOLET-WHAT DO THE NUMBERS SAY?<img src="css/images/main-2.png" height="48" width="48" align="left" style="margin-right:10px"></a>
             &nbsp;&nbsp;<a href="fff.php" style="left: 8px; top: 1px; width: 686px; height: 41px; font-size: 6mm;" style="font-size:3mm">Fitness, form and fluidity are Liverpool’s big concerns<img src="css/images/featured-side-3.jpg" height="48" width="48" align="left" style="margin-right:10px"></a>
